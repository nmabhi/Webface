...
def loadModel():
    ...
    # return True
    with open('/home/wlpt836/webface/model.pkl', 'rb') as f:
        # if sys.version_info[0] < 3:
        mod = pickle.load(f)
        return mod

def loadOfflineModel():
     with open('/home/wlpt836/webface/Feature_dir/classifier.pkl', 'rb') as f:
        if sys.version_info[0] < 3:
...
def loadPeople():
     with open('/home/wlpt836/webface/people.pkl', 'rb') as f:
        # if sys.version_info[0] < 3:
        mod = pickle.load(f)
        return mod
